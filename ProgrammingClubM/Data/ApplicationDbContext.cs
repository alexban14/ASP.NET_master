...
namespace ProgrammingClubM.Data
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Announcement>(entity =>
            {
                entity.HasKey(e => e.Idannouncement)
                    .HasName("PK__Announce__D1C765E7ED5A92A2");
            ...
            modelBuilder.Entity<CodeSnippet>(entity =>
            {
                entity.HasKey(e => e.IdcodeSnippet)
                    .HasName("PK__tmp_ms_x__39AC882198A72590");
            ...
            modelBuilder.Entity<Member>(entity =>
            {
                entity.HasKey(e => e.Idmember)
                    .HasName("PK__Members__7EB75A6375AA1F98");
            ...
            modelBuilder.Entity<Membership>(entity =>
            {
                entity.HasKey(e => e.Idmembership)
                    .HasName("PK__Membersh__4AB986320A4B6F30");
            ...
            modelBuilder.Entity<MembershipType>(entity =>
            {
                entity.HasKey(e => e.IdmembershipType)
                    .HasName("PK__tmp_ms_x__20589C4437405567");
